"""
[JAWABAN ASSIGNMENT WEEK 02]

Aturan pengisian:
- Implementasikan fungsi q01()..q12() sesuai soal di assignments/w02/quiz.qmd
...
def q04() -> str:
    """
    [MC] Jika P(A) = 0,4 dan P(B) = 0,3 serta keduanya saling lepas, maka P(A∪B) adalah:
     A) 0,7
     B) 0,12
     C) 0,1
     D) 0,5
