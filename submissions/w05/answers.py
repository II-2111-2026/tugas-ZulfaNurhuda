"""
[JAWABAN ASSIGNMENT WEEK 05]

Aturan pengisian:
- Implementasikan fungsi q01()..q12() sesuai soal di assignments/w05/quiz.qmd
...
def q06() -> str:
    """
    [MC] Fungsi yang memberikan probabilitas P(X = x) disebut:
     A) PMF.
     B) PDF.
     C) CDF.
     D) MGF.
...
def q07() -> str:
    """
    [MC] Simpangan baku (sigma) adalah:
