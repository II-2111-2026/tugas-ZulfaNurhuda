"""
[JAWABAN ASSIGNMENT WEEK 10]

Aturan pengisian:
- Implementasikan fungsi q01()..q12() sesuai soal di assignments/w10/quiz.qmd
...
def q04() -> str:
    """
    [MC] Jika populasi memiliki sigma = 10 dan ukuran sampel n = 100, maka Standard Error (sigma_X-bar) adalah:
     A) 10
     B) 1
     C) 0,1
     D) 100
...
def q06() -> str:
    """
    [MC] Faktor akar(n) dalam rumus Standard Error menunjukkan bahwa:
