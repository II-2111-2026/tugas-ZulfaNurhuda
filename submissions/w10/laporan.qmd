---
title: "Laporan Minggu 10"
subtitle: "Ringkasan Eksekusi & Inspeksi Kode"
---

::: {.callout-tip title="Tujuan Laporan Ini"}
Laporan ini di-*generate* secara otomatis untuk menampilkan hasil eksekusi kodemu dari `submissions/w10/answers.py` dalam format yang **rapi, terstruktur, dan nyaman dibaca**.
...
```bash
pytest -q checkers/w10/quiz_tests.py
```
...
```bash
quarto render submissions/w10/laporan.qmd
```
:::
