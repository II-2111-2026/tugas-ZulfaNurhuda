"""
[AUTOGRADING TEST — w13]

Script testcase yang disediakan untuk assignment minggu ke-13.
Jawaban mahasiswa diambil dari "submissions/w13/answers.py"
"""
...
from submissions.w13 import answers as A
...
def test_q08():
    assert _num(A.q08()) == 25.0

def test_q09():
    assert math.isclose(_num(A.q09()), 0.8, rel_tol=0.0, abs_tol=0.0005)

def test_q10():
    assert _num(A.q10()) == 0.0

def test_q11():
    assert _num(A.q11()) == 5.0

def test_q12():
    assert _num(A.q12()) == 4.0
