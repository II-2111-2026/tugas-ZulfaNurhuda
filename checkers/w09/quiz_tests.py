"""
[AUTOGRADING TEST — w09]

Script testcase yang disediakan untuk assignment minggu ke-09.
Jawaban mahasiswa diambil dari "submissions/w09/answers.py"
"""
...
from submissions.w09 import answers as A
...
def test_q09():
    assert _num(A.q09()) == 30.0

def test_q10():
    assert math.isclose(_num(A.q10()), 0.25, rel_tol=0.0, abs_tol=0.0005)

def test_q11():
    assert math.isclose(_num(A.q11()), 0.3, rel_tol=0.0, abs_tol=0.0005)

def test_q12():
    assert _num(A.q12()) == 16.0
