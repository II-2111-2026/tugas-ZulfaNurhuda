"""
[AUTOGRADING TEST — w10]

Script testcase yang disediakan untuk assignment minggu ke-10.
Jawaban mahasiswa diambil dari "submissions/w10/answers.py"
"""
...
from submissions.w10 import answers as A
...
def test_q08():
    assert _num(A.q08()) == 50.0

def test_q09():
    assert _num(A.q09()) == 2.0

def test_q10():
    assert _num(A.q10()) == 2.0

def test_q11():
    assert _num(A.q11()) == 1.0

def test_q12():
    assert _num(A.q12()) == 86.0
