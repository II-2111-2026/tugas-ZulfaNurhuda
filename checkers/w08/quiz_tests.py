"""
[AUTOGRADING TEST — w08]

Script testcase yang disediakan untuk assignment minggu ke-08.
Jawaban mahasiswa diambil dari "submissions/w08/answers.py"
"""
...
def test_q10():
    assert math.isclose(_num(A.q10()), 0.01, rel_tol=0.0, abs_tol=0.0005)

def test_q11():
    assert math.isclose(_num(A.q11()), 0.49, rel_tol=0.0, abs_tol=0.0005)

def test_q12():
    assert _num(A.q12()) == 5.0
