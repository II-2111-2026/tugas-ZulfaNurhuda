"""
[AUTOGRADING TEST — w06]

Script testcase yang disediakan untuk assignment minggu ke-06.
Jawaban mahasiswa diambil dari "submissions/w06/answers.py"
"""
...
from submissions.w06 import answers as A
...
def test_q08():
    assert math.isclose(_num(A.q08()), 0.375, rel_tol=0.0, abs_tol=0.0005)

def test_q09():
    assert math.isclose(_num(A.q09()), 0.135, rel_tol=0.0, abs_tol=0.0005)

def test_q10():
    assert _num(A.q10()) == 9.0

def test_q11():
    assert _num(A.q11()) == 10.0
