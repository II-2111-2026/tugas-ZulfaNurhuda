"""
[AUTOGRADING TEST — w03]

Script testcase yang disediakan untuk assignment minggu ke-03.
Jawaban mahasiswa diambil dari "submissions/w03/answers.py"
"""
...
def test_q08():
    assert math.isclose(_num(A.q08()), 0.76, rel_tol=0.0, abs_tol=0.0005)
...
def test_q11():
    assert math.isclose(_num(A.q11()), 0.875, rel_tol=0.0, abs_tol=0.0005)
